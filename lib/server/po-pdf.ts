...
const TERMS: [string, string][] = [
  ...
  ["Documents Required", "Provide Tax Bill, Delivery Challan, E-Way Bill, Packing List, Warranty/User Manual, Test Certificates and statutory documents wherever applicable."],
  ...
  ["Payment Terms", "Payment is subject to receipt, acceptance, valid GST bill and agreed payment terms."],
