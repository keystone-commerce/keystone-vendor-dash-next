...
interface ShowMoreProps {
  ...
  className?: string;
  /**
   * Fixed label to show instead of the default "Show More" / "Show Less" wording —
   * useful when the button sits among others and needs to name what it toggles.
   */
  label?: string;
}

export const ShowMore = ({ expanded = false, onClick, className = "", label }: ShowMoreProps) => {
  return (
