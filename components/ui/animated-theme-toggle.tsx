...
export const AnimatedThemeToggle = ({ className }: { className?: string }) => {
  // The original used local useState, which animated the icon but never changed the
  // page. This is wired to the real theme (adds/removes `dark`, persists the choice).
